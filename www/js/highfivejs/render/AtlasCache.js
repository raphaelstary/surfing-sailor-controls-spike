H5.AtlasCache = (function (SubImage, Math, iterateEntries) {
    ...
    AtlasCache.prototype._createSubImage = function (elem, atlas, scale) {
        return new SubImage(elem.frame.x, elem.frame.y, elem.frame.w, elem.frame.h, this._getOffSetFromCenterX(elem,
            1), this._getOffSetFromCenterY(elem,
            1), elem.spriteSourceSize.w, elem.spriteSourceSize.h, this._getOffSetFromCenterX(elem,
            scale), this._getOffSetFromCenterY(elem, scale), elem.spriteSourceSize.w * scale, elem.spriteSourceSize.h *
            scale, atlas);
    };
